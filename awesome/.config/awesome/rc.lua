...
globalkeys = my_table.join(
    ...
    awful.key({ modkey, "Shift" }, "b", function () awful.util.spawn( browser3 ) end,
...
-- Show/Hide Systray
    ...
    awful.key({ modkey, "Shift"   }, "x", function () awful.util.spawn("/home/richardalmee/.bin/toggle-touchpad") end,
