...
awful.keyboard.append_global_keybindings({
	...
	end, { description = "open primary web browser", group = "launcher" }),
	awful.key({ modkey, ctrl }, "b", function()
		awful.spawn(apps.default.secondary_web_browser)
	end, { description = "open secondary web browser", group = "launcher" }),
	awful.key({ modkey, shift }, "b", function()
		awful.spawn(apps.default.tertiary_web_browser)
	end, { description = "open tertiary web browser", group = "launcher" }),
	awful.key({ modkey }, "space", function()
		awful.spawn.with_shell(apps.default.app_launcher)
	end, { description = "open app launcher", group = "launcher" }),
	awful.key({ modkey, shift }, "space", function()
		awful.spawn.with_shell(apps.default.secondary_app_launcher)
	end, { description = "open secondary app launcher", group = "launcher" }),
})
...
awful.keyboard.append_global_keybindings({
	...
	awful.key({ modkey, ctrl }, ",", awesome.restart, { description = "reload awesome", group = "awesome" }),
...
client.connect_signal("request::default_keybindings", function()
	awful.keyboard.append_client_keybindings({
		...
		awful.key({ modkey, shift }, "é", function(c)
