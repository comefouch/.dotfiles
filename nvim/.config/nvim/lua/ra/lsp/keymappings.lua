...
function M.set_default(client, bufnr)
    ...
    buf_set_keymap('n', '<leader>tt',
                   "<cmd>lua require'lspsaga.provider'.lsp_finder()<CR>", 'lsp',
    ...
    if cap.codeActionProvider then
        ...
        buf_set_keymap('v', '<leader>fa',
                       ...
                       'lsp', 'lsp_code_actions_in_visual',
                       'Code actions (visual)')
    ...
    --[[ buf_set_keymap('n', '[e', "<cmd>lua require'lspsaga.diagnostic'.lsp_jump_diagnostic_prev()<CR>", 'lsp', 'lsp_previous_diagnostic', 'Previous dagnostic')
  buf_set_keymap('n', ']e', "<cmd>lua require'lspsaga.diagnostic'.lsp_jump_diagnostic_next()<CR>", 'lsp', 'lsp_next_diagnostic', 'Next diagnostic'); ]]
    ...
    if cap.renameProvider then
        ...
        buf_set_keymap('n', '<leader>rr',
                       "<cmd>lua require('renamer').rename()<cr>", 'lsp',
                       'lsp_rename', 'Rename')
    end
